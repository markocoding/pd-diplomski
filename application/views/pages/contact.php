<div class="contact-bg animate__animated animate__fadeInLeft">
	<div class="container">
		<div style="color: white">
			...
			<h3 class="display-2 "
				style=";font-weight: 400;color: white; letter-spacing: 2px;  background-color:var(--my-main-color)">
				naši članovi!</h3>
		</div>
	</div>
</div>
	...
	<div class="row ">
		...
		<div class="col-lg-6 col-sm-12">
			...
			<h5 style="line-height: 1.4">
				...
				<a href="<?php echo site_url('assets/download/Evidencioni-list-clana-2021.docx') ?>"
				   download="Evidencioni-list-clana-2021.docx">
					<i class="far fa-file-alt my-download"></i>
				</a><br><br>
				Popunjen formular “Evidencioni karton člana” možete dostaviti elektronskim putem preko emaila Društva
				(pduspon2021@gmail.com), ili ga predati na sastanku Društva (utorkom od 17 do 19 časova). Pored ovoga,
				potrebno je da izvršite uplatu od 900 dinara (800 dinara za članarinu i 100 dinara za člansku karticu
				koja važi 5 godina). Ovu uplatu možete izvršiti na sastanku Društva, ili na račun Društva.</h5>
			<hr>
			...
			<h2 class="p-2"
				...
				kontaktirajte nas elektronskom poštom.</h2>
			<br>
			<br>
			<form>
				<h5>
		...
		<div class="col-lg-6 col-sm-12">
			<div class="sticky-top position-sticky " style="padding-top: 5rem;padding-bottom: 5rem">
				...
				<iframe
					src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d11330.453012488197!2d20.4800159!3d44.7683016!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xd12e2aad5590e385!2sThe%20School%20of%20Electrical%20and%20Computer%20Engineering%20of%20Applied%20Studies!5e0!3m2!1sen!2srs!4v1619890299284!5m2!1sen!2srs"
