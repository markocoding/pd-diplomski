...
<div class="container "  >
	...
	<?php foreach ($guides as $guide):?>
		...
		<div class="row guide-card" data-animate="off" data-animate-type="animate__fadeInUp"  style=" background-color: var(--my-main-color);margin-bottom: 5rem;box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px;">
			<div class="col-md-12">
				<h1 class="display-2 " style=" border-bottom: 1px solid white;">
					<a class="guide-card-link" href="<?php echo site_url('/guides/'.$guide['slug'])?>"><?php echo $guide['name']?></a>
				</h1>
				<div class="row " style="color: white">
					<div class="col-md-3 col-sm-12" style="max-height: 462px; overflow: hidden">
